...
const HomeView = () => {
  return (
    <div className='wrapper container-fluid w-100 d-flex  justify-content-center text-white' id='home'>
      ...
      <div className='main_container w-100 d-lg-flex m-0 ' >
        ...
        <div className='container row ' id='homerow'>
          ...
          <div className='container col-lg-6 col-md-6 col-sm-12 col-12 my-auto mr-3 ' id='Homelinks' >
            ...
            <StyledHomeLink className='italic' to='/work'><h1>Work</h1></StyledHomeLink>
